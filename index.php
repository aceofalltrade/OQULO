...
<html lang="en">
	<head>
	    ...
	    <title> Ace of All Trades Shopping Portal Home Page</title>
		...
		<link href='https://chart.googleapis.com/chart? chs=150x150&cht=qr&chl=123&choe=UTF-8'>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over $ 1000.00</h6>	
				</div>
			</div><!-- .col -->
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="admin/productimages/ https://chart.googleapis.com/chart?/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="300" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>">
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" src= "https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="300" alt=""></a>
			</div><!-- /.image -->			
