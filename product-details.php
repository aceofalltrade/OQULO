...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>" />
                </a>
            </div><!-- /.single-product-gallery-item -->
            ...
            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" />
                </a>
            </div>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div class="item">
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>"/>
                    </a>
                </div>
                <div class="item">

                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=123&choe=UTF-8" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" height="200" />
                    </a>
                </div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="http://facebook.com/shopgateway"></a></li>
						                <li><a class="fa fa-twitter" href="http://www.twitter.com"></a></li>
						                <li><a class="fa fa-linkedin" href="http://www.linkedin.com"></a></li>
						                <li><a class="fa fa-rss" href="http://www.rss.com"></a></li>
						                <li><a class="fa fa-pinterest" href="http://www.pinterest.com"></a></li>
						            </ul>
						        </div>
							</div>
